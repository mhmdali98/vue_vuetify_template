<template>
  <div id="settings-wrapper">
    <v-card
      ...
      link
      min-width="100"
      style="position: fixed; top: 115px; left: -35px; border-radius: 8px;z-index:999"
    >
      <v-icon large class="mr-4">mdi-cog-outline</v-icon>
    </v-card>
    ...
    >
      <v-card class="text-center mb-0" width="300">
        <v-card-text>
          ...
          <strong class="mb-3 d-inline-block">لون القائمة</strong>
          ...
          <v-row align="center" no-gutters>
            <v-col cols="auto">تصغير القائمة</v-col>
